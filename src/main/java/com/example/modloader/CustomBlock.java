...
/**
 * Represents a custom block with configurable behaviors.
 */
public class CustomBlock {
    ...
    public CustomBlock(String id, Material baseMaterial, int customModelData, String displayName, List<String> lore,
                       BlockPlaceBehavior placeBehavior, BlockBreakBehavior breakBehavior, 
                       BlockInteractBehavior interactBehavior, BlockRedstoneBehavior redstoneBehavior, 
    ...
    public BlockPlaceBehavior getPlaceBehavior() { return placeBehavior; }
    public BlockBreakBehavior getBreakBehavior() { return breakBehavior; }
    public BlockInteractBehavior getInteractBehavior() { return interactBehavior; }
    public BlockRedstoneBehavior getRedstoneBehavior() { return redstoneBehavior; }
    public BlockExplodeBehavior getExplodeBehavior() { return explodeBehavior; }
    public List<ItemStack> getCustomDrops() { return customDrops; }
